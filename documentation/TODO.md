...
- [x] Add an old-school mapping tool that builds a simplified map as the party explores. See [Mapping Tool Implementation Plan](MAPPING_TOOL_PLAN.md).
  - Let a player toggle Mapping on from the Cartographer menubar to open the map and reveal the 3×3 grid area around their controlled token; toggling it off stops mapping.
