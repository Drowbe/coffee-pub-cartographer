...
- **Single-glyph door normalization**: Connected door-wall fragments within one grid unit are now collapsed to their first and last endpoints before snapping. Curved or decorative Foundry door construction produces one old-school doorway symbol instead of an accidental double door; crossed secret-door fragments use the same normalization.
